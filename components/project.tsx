...
interface Project {
  ...
  tags: string[];
  githubLink: string;
  liveLink?: string; // Optional if you don't have a Vercel link yet
}
    ...
    <section className="w-full max-w-[1200px] mx-auto px-6 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 cursor-pointer">
        {projects.map((project, index) => (
          <div 
            key={index} 
            className="flex flex-col p-6 border border-gray-200 dark:border-gray-800 rounded-xl hover:border-gray-400 dark:hover:border-gray-600 transition-all duration-300 bg-white dark:bg-gray-950"
          >
